#!/bin/bash
#SBATCH --job-name=r_o_u
#SBATCH --partition=cpu
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=48
#SBATCH --time=04:00:00
#SBATCH --output=logs/%j_run_openmp_ultra.log
#SBATCH --error=logs/errors/%j_run_openmp_ultra.err
#SBATCH --exclusive
...
echo " Description : OpenMP Ultra (${SLURM_CPUS_PER_TASK} Threads)"
